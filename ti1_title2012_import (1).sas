...
*** 每项变量编号， hvar, rvar, ivar, mvar, pvar, avar, lvar, nvar, tvar;
...
%if &max_flag. >= 1 %then %do;
	...
	*** !!! This is problem !!!;
	*** test data: DPL_IL_Cook_20150302.txt;
	*** before merge: ;
	*** raw_0: T|39343803|C|20150223|REF #: 15NW7115156OK;
	*** raw_1: COVER DATE: 2/19/2015;
	*** after merge: ;
	*** raw_all: T|39343803|C|20150223|REF #: 15NW7115156OKCOVER DATE: 2/19/2015ORDER ID: 6491324;
	*** need a blank space ' ' before merged;
...
***scan('m') : 主要是区别连续的delimiter，如果没m，按一个分隔符算，http://goo.gl/wAUid4;
